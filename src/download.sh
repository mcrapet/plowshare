...
VERSION="0.9.3"
MODULES="filesonic rapidshare megaupload 2shared badongo mediafire 4shared zshare depositfiles storage_to uploading netload_in usershare sendspace x7_to hotfile divshare dl_free_fr humyo data_hu 115"
OPTIONS="
